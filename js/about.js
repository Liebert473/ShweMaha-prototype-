...
ScrollReveal().reveal('.member', { ...revealOptions, origin: 'bottom'});
ScrollReveal().reveal('.title', { ...revealOptions, origin: 'left'});
ScrollReveal().reveal('.about-text', { ...revealOptions, origin: 'left'});
ScrollReveal().reveal('.about-img', { ...revealOptions, origin: 'right'});
